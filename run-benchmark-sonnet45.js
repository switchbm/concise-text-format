...
/**
 * Run benchmarks with Claude Sonnet 4.5
 */
...
console.log('CTF LLM Comprehension Test - Claude Sonnet 4.5');
console.log('='.repeat(70));

// Create provider with Claude Sonnet 4.5
...
// Print results
console.log(`\n${'-'.repeat(70)}`);
console.log('RESULTS - Claude Sonnet 4.5');
console.log('-'.repeat(70));
